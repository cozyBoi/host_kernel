cmd_arch/x86/boot/compressed/kaslr.o := gcc -Wp,-MD,arch/x86/boot/compressed/.kaslr.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/8/include -I./arch/x86/include -I./arch/x86/include/generated   -I./include/drm-backport -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -m64 -O2 -fno-strict-aliasing -fPIE -DDISABLE_BRANCH_PROFILING -mcmodel=small -mno-mmx -mno-sse -ffreestanding -fno-stack-protector    -DKBUILD_BASENAME='"kaslr"' -DKBUILD_MODNAME='"kaslr"' -c -o arch/x86/boot/compressed/.tmp_kaslr.o arch/x86/boot/compressed/kaslr.c
...
deps_arch/x86/boot/compressed/kaslr.o := \
  ...
  include/drm-backport/linux/mmu_notifier.h \
